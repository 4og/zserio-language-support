...
// This class defines a complete listener for a parse tree produced by ZserioParser.
export default class ZserioParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterInstantiateDeclaration(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#instantiateDeclaration.
	exitInstantiateDeclaration(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#bitwiseXorExpression.
	enterBitwiseXorExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#bitwiseXorExpression.
	exitBitwiseXorExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#dotExpression.
	enterDotExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#dotExpression.
	exitDotExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#valueofExpression.
	enterValueofExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#valueofExpression.
	exitValueofExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#shiftExpression.
	enterShiftExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#shiftExpression.
	exitShiftExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#arrayExpression.
	enterArrayExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#arrayExpression.
	exitArrayExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#numbitsExpression.
	enterNumbitsExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#numbitsExpression.
	exitNumbitsExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#additiveExpression.
	enterAdditiveExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#additiveExpression.
	exitAdditiveExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#relationalExpression.
	enterRelationalExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#relationalExpression.
	exitRelationalExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#lengthofExpression.
	enterLengthofExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#lengthofExpression.
	exitLengthofExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#identifierExpression.
	enterIdentifierExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#identifierExpression.
	exitIdentifierExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#multiplicativeExpression.
	enterMultiplicativeExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#multiplicativeExpression.
	exitMultiplicativeExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#logicalOrExpression.
	enterLogicalOrExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#logicalOrExpression.
	...
	// Exit a parse tree produced by ZserioParser#bitwiseOrExpression.
	exitBitwiseOrExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#parenthesizedExpression.
	enterParenthesizedExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#parenthesizedExpression.
	exitParenthesizedExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#bitwiseAndExpression.
	enterBitwiseAndExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#bitwiseAndExpression.
	exitBitwiseAndExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#equalityExpression.
	enterEqualityExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#equalityExpression.
	exitEqualityExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#logicalAndExpression.
	enterLogicalAndExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#logicalAndExpression.
	exitLogicalAndExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#functionCallExpression.
	enterFunctionCallExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#functionCallExpression.
	exitFunctionCallExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#indexExpression.
	enterIndexExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#indexExpression.
	exitIndexExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#unaryExpression.
	enterUnaryExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#unaryExpression.
	exitUnaryExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#literalExpression.
	enterLiteralExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#literalExpression.
	exitLiteralExpression(ctx) {
	}


	// Enter a parse tree produced by ZserioParser#ternaryExpression.
	enterTernaryExpression(ctx) {
	}

	// Exit a parse tree produced by ZserioParser#ternaryExpression.
