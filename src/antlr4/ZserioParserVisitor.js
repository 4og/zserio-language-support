...
// This class defines a complete generic visitor for a parse tree produced by ZserioParser.

export default class ZserioParserVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	visitStructureFieldDefinition(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitInstantiateDeclaration(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitDynamicLengthArgument(ctx) {
	  return this.visitChildren(ctx);
	}
